 ...
 * @param {Object} bulkProblemData - 대량 문제 데이터
 * @param {Function} onClose - 모달 닫기 핸들러
 * @param {Function} onSubmit - 제출 핸들러
 * @param {Function} onInputChange - 입력 변경 핸들러
 * @param {Function} onFileChange - 파일 변경 핸들러
 * @param {Function} onAddRow - 행 추가 핸들러
 * @param {Function} onRemoveRow - 행 제거 핸들러
 */
const BulkProblemCreateModal = ({
  isOpen,
  bulkProblemData,
  onClose,
  onSubmit,
                ...
                <div className="tutor-problem-row-content">
                  ...
                  <div className="tutor-form-row">
                    <div className="tutor-form-group">
                      ...
                      <input
                        type="file"
                        onChange={(e) => onFileChange(index, 'descriptionFile', e.target.files[0])}
                        accept=".md,.txt,.tex"
                    ...
                    <div className="tutor-form-group">
                      ...
                      <input
                        type="file"
                        onChange={(e) => onFileChange(index, 'zipFile', e.target.files[0])}
                        accept=".zip"
                        className="tutor-file-input"
                        required
                      />
