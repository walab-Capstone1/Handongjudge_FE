	...
	const fetchProblemForEdit = async (problemId) => {
		try {
				...
				if (typeof parsedData.tags === "string") {
					try {
						...
						tags = Array.isArray(parsedTags)
							? parsedTags.map((t) => t && t.trim()).filter(Boolean)
							: [parsedTags.trim()];
					} catch (e) {
			...
			setFormData({
				...
				tags: tags,
				difficulty:
					parsedData?.difficulty || problem.difficulty?.toString() || "1",
				timeLimit: timeLimit,
							...
							<>
										...
										<div>
											...
											>
												...
												<span style={{ fontSize: "13px", fontStyle: "italic" }}>
													(문제 변환 시 Domjudge까지 변환하는 전체 업데이트가
													수행되며, 새로운 문제로 취급됩니다)
												</span>
											</p>
										</div>
								...
								{enableFullEdit && (
									...
									>
										...
										>
											모든 필드를 수정할 수 있습니다. 변경사항은 Domjudge까지
											변환하는 전체 업데이트를 수행하며, 새로운 문제로
											취급됩니다.
										</p>
									</div>
								)}
													...
													<div className="problem-create-form-section">
														...
														<div className="problem-create-file-upload-wrapper">
															...
															<span className="problem-create-help-text">
																ZIP 파일을 업로드하면 내용을 파싱하여 폼에
																자동으로 채워집니다. 실제 저장 시에는 파싱된
																필드만 전송됩니다.
															</span>
														</div>
													</div>
													...
													<div className="problem-create-form-section problem-create-description-section">
														...
														<div className="problem-create-description-editor">
															...
															<div className="problem-create-preview">
																<div className="problem-create-preview-header">
																	미리보기
																</div>
														...
														{formData.sampleInputs.map((sample, idx) => (
															...
															>
																...
																<div className="problem-create-sample-grid">
																	<div>
																		<label className="problem-create-sample-label">
																			입력
																		</label>
																		<textarea
																			value={sample.input}
												...
												<div className="problem-create-form-section">
													...
													>
														...
														>
															<span>{showParsedTestCases ? "▼" : "▶"}</span>
															<span>
																테스트케이스 ({parsedTestCases.length}개) - 조회
																전용
															</span>
														</button>
														{showParsedTestCases && (
												...
												<tr key={problem.id || index}>
													...
													<td className="tutor-problem-title-cell">
														<button
															...
															onClick={() =>
																onProblemDetail && onProblemDetail(problem.id)
															}
														>
													...
													<td>
														<button
															...
															onClick={() =>
																onProblemViewDetail &&
																onProblemViewDetail(problem.id)
															}
														>
															설명보기
														</button>
